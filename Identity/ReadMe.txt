...
7. Identity проверяет токен своим секретным ключом и выдает в WebApi результат соответствия.
8. WebApi в случае положительного ответа- создает временный токен на основании информации принятого токена,
